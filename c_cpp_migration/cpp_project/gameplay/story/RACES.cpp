...
export const RACES = {
  ...
  synth: {
    ...
    modifiers: {
      shipHullMul: (120 - 100) / 200,     
      shipShieldsMul: (0 - 100) / 200,    
      shipEnergyMul: (150 - 100) / 200,   
      shipSpeedMul: 0.9 - 1.0,            
    },
  },
  ...
  aeon: {
    ...
    modifiers: {
      shipHullMul: (80 - 100) / 200,      
      shipShieldsMul: (50 - 100) / 200,   
      shipEnergyMul: (200 - 100) / 200,   
      shipSpeedMul: 1.05 - 1.0,           
    },
  },
  ...
  drakar: {
    ...
    modifiers: {
      shipHullMul: (140 - 100) / 200,     
      shipShieldsMul: (120 - 100) / 200,  
      shipEnergyMul: (60 - 100) / 200,    
      shipSpeedMul: 0.95 - 1.0,           
    },
  },
  ...
  mycel: {
    ...
    modifiers: {
      shipHullMul: (90 - 100) / 200,      
      shipShieldsMul: (80 - 100) / 200,   
      shipEnergyMul: (140 - 100) / 200,   
      shipSpeedMul: 0.9 - 1.0,            
    },
  },
  ...
  voidborn: {
    ...
    modifiers: {
      shipHullMul: (70 - 100) / 200,      
      shipShieldsMul: (60 - 100) / 200,   
      shipEnergyMul: (180 - 100) / 200,   
      shipSpeedMul: 1.2 - 1.0,            
    },
  },
};
